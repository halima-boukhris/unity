...
public class EnnemiPatrol : MonoBehaviour
{
    ...
    private bool jumpRequested = false;  // indique si l'ennemi veut sauter
    private bool isGrounded = false;     // indique si l'ennemi touche le sol



    void Awake()
    {
        // On s'assure qu'à chaque démarrage du script
        // le nombre de sauts est égal à 0
        jumpCount = 0;
    }
